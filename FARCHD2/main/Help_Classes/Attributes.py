...
#  */
  def getInputAttribute(self, pos):
    ...
    if pos<0 or pos >= len(self.inputAttr):
        ...
        return None
    print("Before return input attribute")
...
#  */
  def getOutputAttribute(self,pos):
    if pos<0 or pos >= len(self.outputAttr):
        return None
    print("self.outputAttr[pos] is :" + str(self.outputAttr[pos]))
  ...
  def setOutputInputAttributes(self,inAttNames, outAttNames):
    ...
    for index in range (0 ,2):
        ...
        for i in range (0,iterations):
            ...
            type_here = att.getType()
            if type_here==Attribute.NOMINAL:
                self.hasNominal = True
            elif type_here==Attribute.INTEGER:
                self.hasInteger = True
            elif type_here == Attribute.REAL:
                self.hasReal = True
...
#  */
  def hasSameAttributeName(attrName,attr_list):
      ...
      print(" return hasSame ==" + str(has_same))
      return has_same
